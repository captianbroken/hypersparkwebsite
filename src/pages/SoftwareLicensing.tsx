...
const licenses = [
  {
    ...
    description:
      "Complete productivity suite with Word, Excel, PowerPoint, Teams, and cloud services for businesses of all sizes.",
    features: [
      "Business Basic",
      "Business Standard",
      "Business Premium",
  ...
  },
  {
    ...
    description:
      "Professional CAD software licensing for architects, engineers, and designers with full support.",
  ...
  },
  {
    ...
    description:
      "Enterprise-grade antivirus and endpoint protection for comprehensive security.",
  ...
  },
  {
    ...
    description:
      "Windows Server and other server operating system licenses with proper CALs.",
  ...
  },
  {
    ...
    description:
      "All enterprise software licenses including Adobe Creative Cloud, VMware, and more.",
    features: [
      ...
      <section className="section-container bg-gradient-to-br from-secondary to-secondary/90">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto mb-8">
            Contact us for the best prices on genuine software licenses with
            full support and compliance assistance.
          </p>
          <Link to="/contact">
            <Button size="lg" className="btn-hero">
              Request a Quote
